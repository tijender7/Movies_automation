...
IMAGE_BASE_OUTPUT_PREFIX_NODE_TITLE = getattr(config, 'SAVE_BASE_IMAGE_NODE_TITLE', 'API_Base_Image_Output_SaveNode') # Node that saves pre-swap img
IMAGE_SWAPPED_OUTPUT_PREFIX_NODE_TITLE = getattr(config, 'SAVE_SWAPPED_IMAGE_NODE_TITLE', 'API_Image_Output_SaveNode') # Node that saves final img
