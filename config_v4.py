# config_v4.py - Targets the final API-ready WanVideo workflow structure
...
print(f"[DEBUG] config_v4.py PROJECT_ROOT_DIR: {PROJECT_ROOT_DIR}")
...
# --- Point to the final V4 workflow file ---
VIDEO_WORKFLOW_TEMPLATE = str((WORKFLOW_TEMPLATE_DIR / "API_wanvideo_v4.json").resolve())
...
# --- Node Titles (Match API_wanvideo_v4.json EXACTLY) ---
# --- Titles for VIDEO Workflow (API_wanvideo_v4.json) ---
...
VIDEO_OUTPUT_SAVE_NODE_TITLE = "Video Combine \ud83c\udfa5\ud83c\udd65\ud83c\udd57\ud83c\udd62" # Title of VHS_VideoCombine (Node #30)
